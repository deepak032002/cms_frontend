...
const Info = () => {
  return (
    <div className="my-6 p-3">
      ...
      <ul className="list-decimal px-3 mx-2 mt-4">
        <li>
          After making the payment online of Rs 600, the applicant will not have
          the option to make any changes to their application.
        </li>
        <li>
          If you have applied successfully and made the payment then there is no
          need to print and submit your application form at Quality Assurance
      ...
      <ul className="list-disc px-5 mx-4 mt-4">
        ...
        <li>
          ...
          the process is interrupted, there is no need to re-register. The
          applicant can login using the same credentials and continue the
          process from wherever the applicant had left.
        </li>
        <li>
          You are advised to check all the data that you have entered before
          making the payment of the application fee of Rs 600. If there is some
          error, you can edit the same or restart the application process, but
          only before the online payment is made.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Upon receiving the application forms, only shortlisted applicants will
          be informed about the date, time and venue of the written test via an
          email / call or both.
        </li>
        <li>
        ...
        <li>
          Consequent upon the performance of the applicant in the written test,
          only the shortlisted candidates will then be informed by email / call
          or both to appear for an in- person interview followed by a demo (only
          for those who qualify the interview). The date time and venue will be
          shared accordingly.
        </li>
        <li>
